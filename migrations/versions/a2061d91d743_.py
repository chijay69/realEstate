...
Revision ID: a2061d91d743
Revises: 
Create Date: 2022-10-23 11:49:29.808818
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('card_type', sa.Enum('debit', 'credit', name='cardtypeenum'), nullable=True),
    ...
    sa.Column('property_status', sa.Enum('rent', 'sale', name='propertystatusenum'), nullable=True),
